...
export function FilterBar() {
  ...
  const issueCount = filterCounts.disabledFeatures + (filterCounts.logErrors > 0 ? 1 : 0);
    ...
    <div className="flex flex-wrap items-center gap-3 py-3 border-b border-[var(--border-glass)] mb-6">
      ...
      <div className="flex items-center gap-2">
        ...
        >
          ...
          <span>Issues</span>
          {issueCount > 0 && (
            <span className={`px-1.5 py-0.5 text-xs rounded-full font-mono font-semibold ${
              activeFilter === 'issues'
      ...
      <div className="flex-1 max-w-xs ml-auto">
        <div className="relative">
          ...
          <input
            ...
            className="input-glass w-full pl-9 pr-8"
          />
          {searchQuery && (
            <button
