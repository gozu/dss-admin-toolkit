...
### Fixed
- Memory Analysis: corrected JEK formula to use Max Jobs (maxRunningActivities / maxRunningActivitiesPerJob) instead of Max Running Activities, since JEK is shared among activities within a job
...
- **Memory Analysis Card** (`MemoryAnalysisCard.tsx`)
  ...
  - JEK Allocation Check: Verifies JEK × Max Jobs fits within cgroup limit
