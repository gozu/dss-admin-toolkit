...
const PAGE_DEFS: PageDef[] = [
  ...
  { id: 'code-envs', label: 'Code Envs', section: 'Code Environments', keywords: ['python', 'environment', 'package'] },
  { id: 'code-env-cleaner', label: 'CodEnv Cleaner', section: 'Code Environments', keywords: ['clean', 'delete', 'unused', 'code env'] },
