...
const PAGE_SECTION_MAP: Record<PageId, SectionInfo> = {
  ...
  'security-config': { label: 'Configuration', firstPage: 'runtime-config' },
  'platform-config': { label: 'Configuration', firstPage: 'runtime-config' },
  logs: { label: 'Logs', firstPage: 'logs' },
  outreach: { label: 'Tools', firstPage: 'outreach' },
  cleaners: { label: 'Tools', firstPage: 'outreach' },
